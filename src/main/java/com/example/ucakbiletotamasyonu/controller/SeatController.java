...
public class SeatController extends RestBaseController {

    @Autowired
    private ISeatService seatService;

    @GetMapping("/by-flight/{flightId}")
    public RootEntity<?> getSeatsByFlight(
        ...
        return ok(seatService.getSeatsByFlight(flightId, status, flightClass));
    }
}
